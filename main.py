...
@app.route("/liked-list", methods = ["GET"])
def like():
  global liked_movies
  return jsonify ({
    "data": liked_movies,
...
def recommended_movies():
    ...
    for i in liked_movies:
        final_list = get_recommendations(liked_movies['original_title'])
        print(liked_movies['original_title'])
        all_recommended = all_recommended.append(final_list)
    ...
    recommended_movie_data.append(_r)
